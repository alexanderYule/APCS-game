...
public class RoomSchema {
	...
	private static void setupRooms() {
		...
		RangedEnemy[] rangedEnemies00 = {
			new RangedEnemy(5,175,175,1,0, 100) ,
			new RangedEnemy(5,595,175,1,0, 100) ,
			new RangedEnemy(5,175,500,1,0, 100) ,
			new RangedEnemy(5,595,500,1,0, 100) 
		} ;

		MeleeEnemy[] meleeEnemies00 = {
			new MeleeEnemy(12,460,100,2, 100) 
		} ;
		...
		RangedEnemy[] rangedEnemies01 = {
			new RangedEnemy(5,175,175,1,0, 100) ,
			new RangedEnemy(5,525,200,1,0, 100) ,
			new RangedEnemy(5,175,475,1,0, 100) ,
			new RangedEnemy(5,525,520,1,0, 100) 
		} ;

		MeleeEnemy[] meleeEnemies01 = {
			new MeleeEnemy(12,460,360,2, 100) 
		} ;
		...
		RangedEnemy[] rangedEnemies02 = {
			new RangedEnemy(5,155,175,0,2, 100) ,
			new RangedEnemy(5,210,500,0,-2, 100) ,
			new RangedEnemy(5,300,150,1,0, 100) ,
			new RangedEnemy(5,625,200,-1,0, 100) ,
			new RangedEnemy(5,300,300,1,0, 100) ,
			new RangedEnemy(5,625,400,1,0, 100) ,
			new RangedEnemy(5,300,425,-1,0, 100) ,
			new RangedEnemy(5,625,500,1,0, 100) ,
		} ;

		MeleeEnemy[] meleeEnemies02 = {
			new MeleeEnemy(12,460,100,2, 100),
			new MeleeEnemy(12,460,600,2, 100),
			new MeleeEnemy(12,700,200,1, 100),
			new MeleeEnemy(12,700,500,1, 100)
		} ;
		...
		RangedEnemy[] rangedEnemies10 = {
			new RangedEnemy(5,600,50,0,1, 100) ,
			new RangedEnemy(5,600,650,0,1, 100) ,
			new RangedEnemy(5,575,225,1,2, 100) ,
			new RangedEnemy(5,675,225,-1,2, 100) ,
		} ;

		MeleeEnemy[] meleeEnemies10 = {
			new MeleeEnemy(12,450,350,4, 100) 
		} ;
		
		StationEnemy[] stationEnemies10 = {
			new StationEnemy(4,150,75,1, 100) ,
			new StationEnemy(4,150,600,1, 100),
			new StationEnemy(4,250,350,1, 100),
		} ;
		...
		RangedEnemy[] rangedEnemies11 = {
			new RangedEnemy(5,260,550,1,0, 100) ,
			new RangedEnemy(5,460,550,1,0, 100) ,
		} ;

		MeleeEnemy[] meleeEnemies11 = {
			new MeleeEnemy(12,550,350,4, 100),
			new MeleeEnemy(12,300,60,4, 100),
		} ;
		
		StationEnemy[] stationEnemies11 = {
			new StationEnemy(4,800,350,1, 100) 
		} ;
		...
		RangedEnemy[] rangedEnemies12 = {
			new RangedEnemy(5,300,550,0,1, 100) ,
			new RangedEnemy(5,450,150,0,3, 100) ,
			new RangedEnemy(5,775,350,0,2, 100) ,
		} ;

		MeleeEnemy[] meleeEnemies12 = {
			new MeleeEnemy(12,585,250,4, 100) 
		} ;
		
		StationEnemy[] stationEnemies12 = {
			new StationEnemy(4,45,550,1, 100), 
			new StationEnemy(4,660,550,1, 100), 
		} ;
		...
		RangedEnemy[] rangedEnemies20 = {
			new RangedEnemy(5,50,80,1,0, 100) ,
			new RangedEnemy(5,500,175,1,0, 100) ,
			new RangedEnemy(5,175,615,1,0, 100) ,
			new RangedEnemy(5,595,615,1,0, 100) 
		} ;

		MeleeEnemy[] meleeEnemies20 = {
			new MeleeEnemy(12,800,100,4, 100) 
		} ;

		StationEnemy[] stationEnemies20 = {
			new StationEnemy(4,380,620,1, 100) 
		};
		...
		MeleeEnemy[] meleeEnemies21 = {
			new MeleeEnemy(12,600,100,4, 100),
		} ;
		
		StationEnemy[] stationEnemies21 = {
				new StationEnemy(4,380,620,1, 100),
				new StationEnemy(4,260,45,1, 100) 
		} ;
		...
		RangedEnemy[] rangedEnemies22 = {
			new RangedEnemy(5,50,80,1,0, 100),
			new RangedEnemy(5,100,510,1,0, 100),
		...
		MeleeEnemy[] meleeEnemies22 = {
			new MeleeEnemy(12,480,400,4, 100),
		} ;
		
		StationEnemy[] stationEnemies22 = {
				new StationEnemy(4,360,620,1, 100),
				new StationEnemy(4,260,45,1, 100),
				new StationEnemy(4,700,390,1, 100) 
		} ;
